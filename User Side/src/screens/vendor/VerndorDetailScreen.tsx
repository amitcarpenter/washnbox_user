import { View,FlatList, Text, ImageBackground, TouchableOpacity, Image, StyleSheet, Linking } from 'react-native';
...
const VerndorDetailScreen = () => {
  ...
  // console.log("vender data ===>",venderData)
  ...
  const renderVendorImageContainer = () =>{
    return(
      <ImageBackground source={USERS.user1} style={styles.topImage}>
        <TouchableOpacity activeOpacity={0.8} onPress={()=>navigation.goBack()} style={styles.backButtonStyle}>
    ...
    return(
      <View style={styles.detailContainer}>
        <View style={styles.serviceContainer}>
          ...
          <Text style={styles.vendorTitle}>{venderData?.shop_name || "Not Available"}</Text>
        </View>
        ...
        <View style={styles.infoContainer}>
          <View style={styles.userInfoRow}>
            <View style={styles.userDetails}>
              ...
              <Text style={styles.userName}>{venderData?.shop_name || "Not Available"}</Text>
            </View>
            <View style={styles.callButtonContainer}>
              <TouchableOpacity onPress={()=>callVendor(venderData?.mobile_number)} style={styles.callIconButton}>
          ...
          <View style={styles.dropOffContainer}>
            ...
            <View style={styles.addressRow}>
              ...
              <View style={styles.directionIconContainer}>
                <Image source={ICONS.direction} style={styles.directionIcon} />
              </View>
            </View>
          </View>
        </View>
  ...
  const renderPlaceOrderButtonContainer = () =>{
    return(
      <View style={styles.footer}>
        <TouchableOpacity onPress={()=>navigation.navigate("OrderDetailScreen")} style={styles.outlinedButtonStyle}>
