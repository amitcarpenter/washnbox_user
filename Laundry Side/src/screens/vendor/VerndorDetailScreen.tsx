...
const VerndorDetailScreen = () => {
  return (
    <Container containerStyle={styles.container}>
      <ImageBackground source={IMAGES.vendor} style={styles.topImage}>
      ...
      <View style={styles.detailContainer}>
        <View style={styles.serviceContainer}>
          <View style={styles.serviceRow}>
            {['Iron', 'Dry Clean', 'Washing'].map((item, index) => (
              <Text key={index} style={styles.serviceText} ellipsizeMode='tail'>
                {item}
              </Text>
            ))}
          </View>
          <Text style={styles.vendorTitle}>Mr. Iron man and Wash service</Text>
        </View>
        ...
        <View style={styles.infoContainer}>
          <View style={styles.userInfoRow}>
            <View style={styles.userDetails}>
              ...
              <Text style={styles.userName}>Mrs. Kirk Conroy</Text>
            </View>
